...
// CategoryInfo CategoryInfo - a choice of a value from a category.
...
func (m *CategoryInfo) validateID(formats strfmt.Registry) error {
...
func (m *CategoryInfo) validateValue(formats strfmt.Registry) error {
