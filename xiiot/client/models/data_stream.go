...
type DataStream struct {
	...
	// Enum: [Kafka ElasticSearch MQTT None]
	...
	// User will specify the endpoint!
	...
	// Enum: [PubSub CloudDatastore CloudSQL]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["Edge","Cloud"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["Kafka","ElasticSearch","MQTT","None"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["PubSub","CloudDatastore","CloudSQL"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
