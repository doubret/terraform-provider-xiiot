...
// WithAuthorization adds the authorization to the application get params
func (o *ApplicationGetParams) WithAuthorization(authorization string) *ApplicationGetParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the application get params
func (o *ApplicationGetParams) SetAuthorization(authorization string) {
	o.Authorization = authorization
}

// WithID adds the id to the application get params
func (o *ApplicationGetParams) WithID(id string) *ApplicationGetParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the application get params
func (o *ApplicationGetParams) SetID(id string) {
	o.ID = id
}
