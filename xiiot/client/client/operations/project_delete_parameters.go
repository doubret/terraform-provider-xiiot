...
// WithAuthorization adds the authorization to the project delete params
func (o *ProjectDeleteParams) WithAuthorization(authorization string) *ProjectDeleteParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the project delete params
func (o *ProjectDeleteParams) SetAuthorization(authorization string) {
