...
// WithAuthorization adds the authorization to the user create params
func (o *UserCreateParams) WithAuthorization(authorization string) *UserCreateParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the user create params
func (o *UserCreateParams) SetAuthorization(authorization string) {
