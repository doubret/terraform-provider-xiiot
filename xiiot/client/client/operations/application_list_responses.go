...
func (o *ApplicationListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		result := NewApplicationListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewApplicationListBadRequest creates a ApplicationListBadRequest with default headers values
func NewApplicationListBadRequest() *ApplicationListBadRequest {
	return &ApplicationListBadRequest{}
}

/*ApplicationListBadRequest handles this case with default header values.

Bad request
*/
type ApplicationListBadRequest struct {
}

func (o *ApplicationListBadRequest) Error() string {
	return fmt.Sprintf("[GET /applications][%d] applicationListBadRequest ", 400)
}

func (o *ApplicationListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ApplicationListDefault) Error() string {
	return fmt.Sprintf("[GET /applications][%d] ApplicationList default ", o._statusCode)
}
