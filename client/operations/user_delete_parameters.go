...
// WithAuthorization adds the authorization to the user delete params
func (o *UserDeleteParams) WithAuthorization(authorization string) *UserDeleteParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the user delete params
func (o *UserDeleteParams) SetAuthorization(authorization string) {
	o.Authorization = authorization
}

// WithID adds the id to the user delete params
func (o *UserDeleteParams) WithID(id string) *UserDeleteParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the user delete params
func (o *UserDeleteParams) SetID(id string) {
	o.ID = id
}
